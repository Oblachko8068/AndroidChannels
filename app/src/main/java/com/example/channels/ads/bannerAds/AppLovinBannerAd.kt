...
const val adAppLovinBannerId = "demo-banner-applovin"

class AppLovinBannerAd(val context: Context) {
    ...
    fun loadBannerAd() {
        ...
        bannerAd?.setAdUnitId(adAppLovinBannerId)
